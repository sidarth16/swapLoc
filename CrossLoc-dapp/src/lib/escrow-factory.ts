...
// async function main() {
//   console.log("Sdk.NetworkEnum.BINANCE:", Sdk.NetworkEnum.BINANCE);
//   console.log("Sdk.NetworkEnum.ETHEREUM:", Sdk.NetworkEnum.ETHEREUM);

//   // Optional: sanity check other SDK exports
//   const randSalt = Sdk.randBigInt(1000n);
//   console.log("Random salt:", randSalt.toString());
// }
